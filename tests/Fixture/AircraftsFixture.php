 ...
 *
 */
class AircraftsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'type' => ['type' => 'string', 'length' => 64, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '机型', 'precision' => null, 'fixed' => null],
        'maker' => ['type' => 'string', 'length' => 64, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '厂商', 'precision' => null, 'fixed' => null],
